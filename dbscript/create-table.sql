...
(
    `AAPP_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '발령결재코드',
    `AAPP_NO`    VARCHAR(255) NOT NULL COMMENT '발령번호',
    `AAPP_DATE`    DATE NOT NULL COMMENT '발령일',
    `AAPP_NAME`    VARCHAR(255) NOT NULL COMMENT '발령명',
    `AAPP_TYPE`    VARCHAR(255) NOT NULL COMMENT '발령종류',
    `AAPP_CON`    VARCHAR(255) NOT NULL COMMENT '발령내용',
...
(
    `AATT_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '근태결재코드',
...
(
    ...
    `AD_TITLE`    VARCHAR(255) NOT NULL COMMENT '결재 제목',
    `AD_WRITER`    VARCHAR(255) NOT NULL COMMENT '작성자',
...
(
    `AE_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '기타결재코드',
...
(
    ...
    `AE_CODE`    INTEGER NOT NULL COMMENT '기타결재코드',
    `AATT_CODE`    INTEGER NOT NULL COMMENT '근태결재코드',
    `AP_CODE`    INTEGER NOT NULL COMMENT '인사결재코드',
    `AAPP_CODE`    INTEGER NOT NULL COMMENT '발령결재코드',
    `AL_CODE`    INTEGER NOT NULL COMMENT '결재라인코드',
    PRIMARY KEY ( `AF_CODE` )
    ) COMMENT = '결재양식';
...
(
    ...
    `AL_ROLE`    INTEGER NOT NULL COMMENT '결재역할',
    `EMP_CODE`    INTEGER NOT NULL COMMENT '사원 코드(결재자)',
    `TITLE_CODE`    VARCHAR(10) NOT NULL COMMENT '직책 코드(결재자)',
...
(
    `AP_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '인사결재코드',
...
(
    ...
    `COMM_DATE`    DATE NOT NULL COMMENT '댓글 작성일',
...
(
    ...
    `EMP_PASS`    INTEGER NOT NULL COMMENT '사원 비밀번호',
    `SOCIAL_SECURITY_NO`    INTEGER NOT NULL COMMENT '주민등록번호',
    `EMAIL`    VARCHAR(255) COMMENT '이메일',
    `PHONE`    VARCHAR(255) COMMENT '전화번호',
    `ADDRESS`    VARCHAR(255) COMMENT '주소',
    `DIRECT_LINE`    INTEGER COMMENT '직통번호',
    `ACCOUNT_NUM`    INTEGER COMMENT '계좌번호',
...
(
    `EVENT_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '일정 코드',
    `TITLE`    VARCHAR(30) NOT NULL COMMENT '제목',
    `EVENT_CON`    VARCHAR(300) NOT NULL COMMENT '내용',
    `START_DATE`    DATETIME NOT NULL COMMENT '시작일',
    `END_DATE`    DATETIME NOT NULL COMMENT '종료일',
    `ALLDAY`    CHAR(1) NOT NULL COMMENT '종일여부',
    `EVENT_GUESTS`    VARCHAR(30) COMMENT '참석자',
    `EMP_CODE`    INTEGER NOT NULL COMMENT '사원 코드',
    `LABEL_CODE`    INTEGER NOT NULL COMMENT '라벨코드',
...
(
    `FEED_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '피드코드',
    `FEED_CON`    VARCHAR(225) NOT NULL COMMENT '피드내용',
    ...
    `EVENT_CODE`    INTEGER NOT NULL COMMENT '일정 코드',
    `POST_CODE`    VARCHAR(255) NOT NULL COMMENT '게시글 코드',
    `MSG_CODE`    VARCHAR(255) NOT NULL COMMENT '쪽지 코드',
    `AD_CODE`    VARCHAR(255) NOT NULL COMMENT '결재문서코드',
    PRIMARY KEY ( `FEED_CODE` )
    ) COMMENT = '피드';


CREATE TABLE IF NOT EXISTS `GUEST`
(
    `GET_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '캘린더 코드',
    `EMP_CODE`    INTEGER NOT NULL COMMENT '사원 코드(등록자, 참석자)',
    `EVENT_CODE`    INTEGER NOT NULL COMMENT '일정 코드',
    `TASK_CODE`    INTEGER NOT NULL COMMENT '업무 코드',
...
(
    `LABEL_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '라벨코드',
    `LABEL_TITLE`    VARCHAR(30) NOT NULL COMMENT '제목',
    `LABEL_CON`    VARCHAR(30) NOT NULL COMMENT '설명',
    `LABEL_COLOR`    VARCHAR(30) NOT NULL COMMENT '색상',
...
(
    `OW_STATUS`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '초과근무코드',
    `START_TIME`    DATETIME NOT NULL COMMENT '시작일',
    `END_TIME`    DATETIME NOT NULL COMMENT '종료일',
    `EMP_CODE`    INTEGER NOT NULL COMMENT '사원 코드',
    PRIMARY KEY ( `OW_STATUS` )
    ) COMMENT = '초과근무 일정';
...
(
    `TASK_CODE`    INTEGER NOT NULL AUTO_INCREMENT COMMENT '업무 코드',
    `TITLE`    VARCHAR(30) NOT NULL COMMENT '제목',
    `TAST_MODI_DATE`    DATE COMMENT '수정일',
    `START_DATE`    DATETIME NOT NULL COMMENT '시작일',
    `END_DATE`    DATETIME NOT NULL COMMENT '종료일',
    `TASK_STATUS`    CHAR(1) DEFAULT 'A' NOT NULL COMMENT '상태',
    `TASK_PRI`    CHAR(1) DEFAULT 'L' NOT NULL COMMENT '우선순위',
    `TASK_CON`    VARCHAR(300) NOT NULL COMMENT '내용',
    `TASK_OWNER`    VARCHAR(30) NOT NULL COMMENT '담당자',
    `TASK_DISPLAY`    CHAR(1) DEFAULT 'N' NOT NULL COMMENT '캘린더 표시',
    `EMP_CODE`    INTEGER NOT NULL COMMENT '사원 코드',
