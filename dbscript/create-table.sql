...
(
    ...
    `DEPT_CODE`      VARCHAR(255) NOT NULL COMMENT '부서/팀',
...
(
    ...
    PRIMARY KEY ( `PAR_DEPT_CODE`,`SUB_DEPT_CODE` )
...
(
    ...
    `DO_USED`    INTEGER NOT NULL COMMENT '신청일수',
    ...
    `DB_CODE`    INTEGER NOT NULL COMMENT '휴가코드',
    PRIMARY KEY ( `DO_CODE` )
...
(
    ...
    `DB_USED`    INTEGER NOT NULL COMMENT '사용수',
    `EMP_CODE`    INTEGER NOT NULL COMMENT '사원 코드',
