...
(
    ...
    `FEED_SORT` VARCHAR(255) NOT NULL COMMENT '피드 분류',
    `EMP_CODE`    INTEGER NOT NULL COMMENT '사원 코드',
...
(
    ...
    )ENGINE=INNODB COMMENT = '라벨';

CREATE TABLE IF NOT EXISTS `EVENT`
(
    `EVENT_CODE`    VARCHAR(255) NOT NULL COMMENT '일정 코드',
    `TITLE`    VARCHAR(30) NOT NULL COMMENT '제목',
...
(
    ...
    `AF_SORT` VARCHAR(255) NOT NULL COMMENT '결재양식분류',
    PRIMARY KEY ( `AF_CODE` )
